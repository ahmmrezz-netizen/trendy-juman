        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Purchase Information</h6>
                </div>
                <div class="card-body">
                                ...
                                <select class="form-select @error('client_id') is-invalid @enderror" 
                                    ...
                                    @foreach($clients as $client)
                                        <option value="{{ $client->id }}" 
                                                {{ old('client_id', $purchase->client_id) == $client->id ? 'selected' : '' }}>
